...
> 빌드에 필요한 데이터, 한 곳에. 핵심은 **키·가입 없이.** / All the data you need — core sources need **no API key, no signup.** Road to ICML 2026 Seoul.

## 📖 데이터는 두 종류 / Two kinds of data
- **✅ 정적 (파일로 줌 · 오프라인)** — 104경기·점수·골 · 12개조 · 48팀 명단 · 16구장 · 팀+국기 이모지 · World Bank GDP/인구
- **🌐 라이브/키 (주소로 줌)** — 실시간 스코어 · 날씨 · 배당. 라이브는 박제 못 해서 **링크**.

## 🚀 30초 시작 — 키 없음 / Quickstart (no key)
```js
...
## 🌐 더 찾아볼 곳 / Where to look (표시 없으면 키 불필요)
| 무엇 | 주소 | 메모 |
|---|---|---|
